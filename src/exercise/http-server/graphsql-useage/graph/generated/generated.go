...
func (ec *executionContext) field_Mutation_createTask_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNNewTask2graphqlᚋgraphᚋmodelᚐNewTask(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Query_getAllTasks(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Task)
	fc.Result = res
	return ec.marshalOTask2ᚕᚖgraphqlᚋgraphᚋmodelᚐTask(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_getTask(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().GetTask(rctx, fc.Args["id"].(*int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.(*model.Task)
	fc.Result = res
	return ec.marshalOTask2ᚖgraphqlᚋgraphᚋmodelᚐTask(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Task_Attachments(ctx context.Context, field graphql.CollectedField, obj *model.Task) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOAttachment2ᚕᚖgraphqlᚋgraphᚋmodelᚐAttachmentᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputNewTask(ctx context.Context, obj interface{}) (model.NewTask, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "Attachments":
			...
			it.Attachments, err = ec.unmarshalONewAttachment2ᚕᚖgraphqlᚋgraphᚋmodelᚐNewAttachmentᚄ(ctx, v)
			if err != nil {
				return it, err
			}
		}
...
func (ec *executionContext) marshalNAttachment2ᚖgraphqlᚋgraphᚋmodelᚐAttachment(ctx context.Context, sel ast.SelectionSet, v *model.Attachment) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) unmarshalNNewAttachment2ᚖgraphqlᚋgraphᚋmodelᚐNewAttachment(ctx context.Context, v interface{}) (*model.NewAttachment, error) {
	res, err := ec.unmarshalInputNewAttachment(ctx, v)
	return &res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) unmarshalNNewTask2graphqlᚋgraphᚋmodelᚐNewTask(ctx context.Context, v interface{}) (model.NewTask, error) {
...
func (ec *executionContext) marshalOAttachment2ᚕᚖgraphqlᚋgraphᚋmodelᚐAttachmentᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Attachment) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNAttachment2ᚖgraphqlᚋgraphᚋmodelᚐAttachment(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) unmarshalONewAttachment2ᚕᚖgraphqlᚋgraphᚋmodelᚐNewAttachmentᚄ(ctx context.Context, v interface{}) ([]*model.NewAttachment, error) {
	if v == nil {
		return nil, nil
	}
	var vSlice []interface{}
	...
	for i := range vSlice {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithIndex(i))
		res[i], err = ec.unmarshalNNewAttachment2ᚖgraphqlᚋgraphᚋmodelᚐNewAttachment(ctx, vSlice[i])
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) marshalOTask2ᚕᚖgraphqlᚋgraphᚋmodelᚐTask(ctx context.Context, sel ast.SelectionSet, v []*model.Task) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalOTask2ᚖgraphqlᚋgraphᚋmodelᚐTask(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalOTask2ᚖgraphqlᚋgraphᚋmodelᚐTask(ctx context.Context, sel ast.SelectionSet, v *model.Task) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Task(ctx, sel, v)
